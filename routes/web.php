...
Route::post('/loginp', [App\Http\Controllers\loginpatient::class, 'login'])->name('loginp');
Route::get('/index', [App\Http\Controllers\index::class, 'index'])->name('index')->middleware(['check','whatsappmail']);
...
Route::post('/sendmail', [App\Http\Controllers\mailcl::class, 'mail'])->name('sendmail')->middleware(['check','whatsappmail']);;
